 ...
 */
//邮件适配器
public class AdapterDrafts extends BaseAdapter {
    //待显示邮件列表
    private List<MailBean> mailList;
    private LayoutInflater listContainer;
    public AdapterDrafts(Context context, List<MailBean> mailList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            view = listContainer.inflate(R.layout.mail_item_drafts, null);
            //获得ViewHolder对象
            viewHolder = new ViewHolderOfMail();
            viewHolder.sender = (TextView) view.findViewById(R.id.mail_sender_drafts);
            viewHolder.mailTitle = (TextView) view.findViewById(R.id.mail_title_drafts);
            viewHolder.mailDate = (TextView) view.findViewById(R.id.mail_date_drafts);
            viewHolder.mailIcon = (ImageView) view.findViewById(R.id.mail_icon_drafts);
