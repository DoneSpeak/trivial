 ...
 */
//邮件适配器
public class AdapterSentMail extends BaseAdapter {
    //待显示邮件列表
    private List<MailBean> mailList;
    private LayoutInflater listContainer;
    public AdapterSentMail(Context context, List<MailBean> mailList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            view = listContainer.inflate(R.layout.mail_item_sent, null);
            //获得ViewHolder对象
            viewHolder = new ViewHolderOfMail();
            viewHolder.sender = (TextView) view.findViewById(R.id.mail_sender_sent);
            viewHolder.mailTitle = (TextView) view.findViewById(R.id.mail_title_sent);
            viewHolder.mailDate = (TextView) view.findViewById(R.id.mail_date_sent);
            viewHolder.mailIcon = (ImageView) view.findViewById(R.id.mail_icon_sent);
