 ...
 */
//邮件适配器
public class AdapterDeletedbox extends BaseAdapter {
    //待显示邮件列表
    private List<MailBean> mailList;
    private LayoutInflater listContainer;
    public AdapterDeletedbox(Context context, List<MailBean> mailList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            view = listContainer.inflate(R.layout.mail_item_deleted, null);
            //获得ViewHolder对象
            viewHolder = new ViewHolderOfMail();
            viewHolder.sender = (TextView) view.findViewById(R.id.deleted_mail_sender);
            viewHolder.mailTitle = (TextView) view.findViewById(R.id.deleted_mail_title);
            viewHolder.mailDate = (TextView) view.findViewById(R.id.deleted_mail_date);
            viewHolder.mailIcon = (ImageView) view.findViewById(R.id.deleted_mail_icon);
