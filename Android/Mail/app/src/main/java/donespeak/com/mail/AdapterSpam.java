...
public class AdapterSpam extends BaseAdapter {
    ...
    public AdapterSpam(Context context, List<MailBean> mailList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            view = listContainer.inflate(R.layout.mail_item_spam, null);
            //获得ViewHolder对象
            viewHolder = new ViewHolderOfMail();
            viewHolder.sender = (TextView) view.findViewById(R.id.mail_sender_spam);
            viewHolder.mailTitle = (TextView) view.findViewById(R.id.mail_title_spam);
            viewHolder.mailDate = (TextView) view.findViewById(R.id.mail_date_spam);
            viewHolder.mailIcon = (ImageView) view.findViewById(R.id.mail_icon_spam);
